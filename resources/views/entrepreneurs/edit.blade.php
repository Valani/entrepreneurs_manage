...
<form action="{{ route('entrepreneurs.update', $entrepreneur) }}" method="POST">
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control @error('ipn') is-invalid @enderror"
            id="ipn" name="ipn" value="{{ old('ipn', $entrepreneur->ipn) }}" required>
        @error('ipn')
        <div class="invalid-feedback">{{ $message }}</div>
        @enderror
    </div>
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control @error('iban') is-invalid @enderror"
            id="iban" name="iban" value="{{ old('iban', $entrepreneur->iban) }}" required>
        @error('iban')
        <div class="invalid-feedback">{{ $message }}</div>
        @enderror
    </div>
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control @error('tax_office_name') is-invalid @enderror"
            ...
            value="{{ old('tax_office_name', $entrepreneur->tax_office_name) }}" required>
